...
const User = () => {
    ...
    const [accessToken, setAcessToken] = useState<string>(localAccessToken)
    ...
    return (
        <>
            ...
            <TextField id="outlined-basic" label="User ID" value={userId} onChange={(e)=>{setUserId(e.target.value)}} variant="outlined" />
            <TextField id="outlined-basic" label="Token" value={accessToken} onChange={(e)=>{setAcessToken(e.target.value)}} variant="outlined" />
        </>
    )
}
