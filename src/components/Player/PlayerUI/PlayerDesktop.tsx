      ...
      <>
        {!isOpen ? (
            <div className="fixed flex flex-row items-center bottom-0 w-full p-2.5 bg-black bg-opacity-50 backdrop-blur-sm rounded-tl-xl rounded-tr-xl gap-10 transition-all duration-400 ease-in">
              {/* Track Info */}
              <div className="flex flex-row items-center w-[30%] whitespace-nowrap overflow-hidden text-ellipsis hover:bg-background-secondary-hover">
                <Cover
              ...
              {/* Primary Controls */}
              <div className="flex flex-col justify-center flex-grow gap-1.5">
              ...
              <div className="flex items-center w-[30%] pr-10">
                <div className="flex flex-row justify-center items-center">
                  <div
                      className="flex justify-center items-center w-[30px] h-[30px] text-white cursor-pointer"
