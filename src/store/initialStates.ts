...
export const MessageInitState= {message:"",code:200 as ErrCodeT,active:false}
export const SongInitState = {id:0,title:"",artists:[{id:0,cover:{uri:""},name:"",likesCount:0}],url:"",coverUri:"",chart:{bgColor:"",listeners:0,position:0,progress: "same" as ProgressT,shift:0},available: true, durationMs:0,albums:[]}
export const HeaderInitState = {title:"",imgUrl:"",active:false}
